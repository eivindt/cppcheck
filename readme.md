...
|:-:|:--:|:--:|:--:|:--:|:-:|
|[![Github Action Status](https://github.com/eivindt/cppcheck/workflows/CI/badge.svg)](https://github.com/eivindt/cppcheck/actions?query=workflow%3ACI)|[![Linux Build Status](https://img.shields.io/travis/eivindt/cppcheck/main.svg?label=Linux%20build)](https://travis-ci.org/eivindt/cppcheck)|[![Windows Build Status](https://img.shields.io/appveyor/ci/eivindt/cppcheck/main.svg?label=Windows%20build)](https://ci.appveyor.com/project/eivindt/cppcheck/branch/main)|[![OSS-Fuzz](https://oss-fuzz-build-logs.storage.googleapis.com/badges/cppcheck.svg)](https://bugs.chromium.org/p/oss-fuzz/issues/list?sort=-opened&can=1&q=proj:cppcheck)|[![Coverity Scan Build Status](https://img.shields.io/coverity/scan/512.svg)](https://scan.coverity.com/projects/512)|[![License](https://img.shields.io/badge/license-GPL3.0-blue.svg)](https://opensource.org/licenses/GPL-3.0) 
